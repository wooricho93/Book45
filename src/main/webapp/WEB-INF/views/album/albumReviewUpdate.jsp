...
<body>
		<div class="wrapper_div">
			...
			<div class="content_div">
				<h4>리뷰</h4>
				<textarea name="content">${albumReview.content}</textarea>
			</div>
		</div>
			<div class="btn_wrap">
...
$(".update_btn").on("click", function(e){
	...
	const num = '${albumReview.num}';  
	const productNum = '${albumReview.productNum}';
	const id = '${id}';
