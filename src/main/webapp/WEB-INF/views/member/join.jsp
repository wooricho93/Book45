...
<body>
   <div id="container">
   		<div id="hlogo">
			<h1 id="logo">
				<a href="/main">
					<img alt="LOGO" src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FCdrYl%2FbtrUTKBvWql%2FneUhG0VH9Jro8xRV8EGl61%2Fimg.png" width="65%" height="100%">
				</a>
			</h1>
		</div>
   <form id="joinForm" method="post">
   		...
   		<div id="joinbox">
   			...
   			<div id="idbox">
   			<input type="text" name="id" class="id" id="idtextbox" placeholder="아이디를 입력해 주세요">
   			</div>
   			...
   			<input type="text" class="name" name="name" id="textbox" placeholder="이름을 입력해 주세요">
            ...
            <p style="margin: 20px 0 10px 0;">이메일</p>
   			<input type="text" class="email" name="email" id="textbox" placeholder="이메일을 입력해 주세요">
   			<span class="finalEmailCheck">이메일은 필수 입력 사항입니다.</span>
   			<div class="emailBox">
	   			<input type="text" name="emailCode" class="emailCode" id="textbox" placeholder="인증번호를 입력해 주세요" disabled="disabled">
	   			<input type="button" value="인증번호 전송" class="emailCodeBtn" id="overlap">
   			</div>
   			<span class="codeCheck1">인증번호가 일치합니다.</span>
   			<span class="codeCheck2">인증번호가 일치하지 않습니다. 다시 확인해 주세요.</span>
...
$(document).ready(function() {
	$("#roger").click(function() {
		...
		if (idCheck && idDoubleCheck && pwCheck && pwDoubleCheck && pwFinalCheck && nameCheck && nicknameCheck && nicknameDoubleCheck && phoneCheck && emailCheck && emailCodeCheck && addressCheck) {
			alert("회원가입이 완료되었습니다.");
